...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "b", function() awful.util.spawn("flatpak run org.qutebrowser.qutebrowser") end, {description = "open qutebrowser", group = "launcher"})
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "m",
        function (c) c.maximized_vertical = not c.maximized_vertical c:raise() end , {description = "(un)maximize vertically", group = "client"}),
