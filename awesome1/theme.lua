...
local mem_color = "#4B696D"
local clock_color = "#8DAA9A"
...
function theme.at_screen_connect(s)
	...
	s.mywibox:setup({
		...
		{ -- Right widgets
			layout = wibox.layout.fixed.horizontal,
			arrow(theme.bg_normal, mem_color),
			...
			arrow(mem_color, clock_color),
			wibox.container.background(wibox.container.margin(binclock, dpi(4), dpi(8)), clock_color),
			arrow(clock_color, "alpha"),
			--]]
			s.mylayoutbox,
		},
	})
